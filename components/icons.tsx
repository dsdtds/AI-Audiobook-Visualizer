...
export const LoadingSpinner: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    ...
    `}</style>
    <path d="M21 12a9 9 0 1 1-6.219-8.56" className="animate-spin" style={{transformOrigin: 'center'}}/>
  </svg>
);
...
export const PlayIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M5 21V3l14 9-14 9Z"/></svg>
);

export const StopIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M6 18h12V6H6v12Z"/></svg>
);
